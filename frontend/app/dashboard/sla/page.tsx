        ...
        <div className="p-8 space-y-8">
            ...
            {aiAnalysis ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <CardContent>
                            <div className="text-center mb-6">
                                <div className="text-5xl font-bold text-foreground mb-2">
                                    {aiAnalysis.risk_score}<span className="text-2xl text-purple-600 dark:text-purple-400">%</span>
                                </div>
                    ...
                    <Card className="shadow-md dark:shadow-none bg-card">
                        <CardHeader>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-foreground">
                                    ...
                                    <div className="bg-secondary/50 dark:bg-gray-800/50 p-4 rounded-xl border border-border/50">
                                        ...
                                        <div className="text-xl font-black text-blue-600 dark:text-blue-400">
                                            {aiAnalysis.forecast.next_hour_avg_latency.toFixed(0)}<span className="text-xs ml-0.5">ms</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <Card className="shadow-md dark:shadow-none">
                        ...
                        <CardContent className="space-y-4">
                            {aiAnalysis.recommendations.map((rec, i) => (
                                <div key={i} className="bg-secondary/30 dark:bg-gray-800/30 border border-border rounded-xl p-4 transition-all hover:bg-secondary/50">
                                    ...
                                    <div className="text-[11px] font-semibold text-green-600 dark:text-green-400 flex items-center gap-1.5 p-1.5 bg-green-50 dark:bg-green-500/10 rounded-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-foreground">{metrics.avg_response_time_ms.toFixed(0)}ms</div>
